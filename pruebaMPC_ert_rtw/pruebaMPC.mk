###########################################################################
## Makefile generated for Simulink model 'pruebaMPC'. 
## 
## Makefile     : pruebaMPC.mk
## Generated on : Thu Sep 13 11:20:20 2018
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/pruebaMPC.exe
...
MODELREF_LINK_RSPFILE_NAME = pruebaMPC_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = pruebaMPC_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/pruebaMPC.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/pruebaMPC_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=pruebaMPC -DNUMST=3 -DNCSTATES=12 -DHAVESTDIO
...
SRCS = $(START_DIR)/pruebaMPC_ert_rtw/pruebaMPC.c $(START_DIR)/pruebaMPC_ert_rtw/pruebaMPC_data.c

MAIN_SRC = $(START_DIR)/pruebaMPC_ert_rtw/ert_main.c
...
OBJS = pruebaMPC.obj pruebaMPC_data.obj
...
%.obj : $(START_DIR)/pruebaMPC_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
