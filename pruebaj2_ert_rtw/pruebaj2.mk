###########################################################################
## Makefile generated for Simulink model 'pruebaj2'. 
## 
## Makefile     : pruebaj2.mk
## Generated on : Mon Sep 17 15:20:08 2018
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/pruebaj2.exe
...
MODELREF_LINK_RSPFILE_NAME = pruebaj2_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = pruebaj2_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/pruebaj2.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/pruebaj2_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=pruebaj2 -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO
...
SRCS = $(START_DIR)/pruebaj2_ert_rtw/pruebaj2.c

MAIN_SRC = $(START_DIR)/pruebaj2_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/pruebaj2_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
