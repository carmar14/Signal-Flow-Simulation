###########################################################################
## Makefile generated for Simulink model 'pruebaj'. 
## 
## Makefile     : pruebaj.mk
## Generated on : Mon Sep 17 15:18:08 2018
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/pruebaj.exe
...
MODELREF_LINK_RSPFILE_NAME = pruebaj_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = pruebaj_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/pruebaj.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/pruebaj_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=pruebaj -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO
...
SRCS = $(START_DIR)/pruebaj_ert_rtw/pruebaj.c

MAIN_SRC = $(START_DIR)/pruebaj_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/pruebaj_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
