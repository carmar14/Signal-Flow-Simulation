...
this.def["biomasa_B"] = {file: "biomasa_c.html",line:20,type:"var"};
this.def["biomasa_X"] = {file: "biomasa_c.html",line:23,type:"var"};
this.def["biomasa_DW"] = {file: "biomasa_c.html",line:26,type:"var"};
this.def["biomasa_U"] = {file: "biomasa_c.html",line:29,type:"var"};
this.def["biomasa_Y"] = {file: "biomasa_c.html",line:32,type:"var"};
this.def["biomasa_M_"] = {file: "biomasa_c.html",line:35,type:"var"};
this.def["biomasa_M"] = {file: "biomasa_c.html",line:36,type:"var"};
this.def["rt_TDelayInterpolate"] = {file: "biomasa_c.html",line:47,type:"fcn"};
this.def["rt_ertODEUpdateContinuousStates"] = {file: "biomasa_c.html",line:224,type:"fcn"};
this.def["rt_hypotd_snf"] = {file: "biomasa_c.html",line:381,type:"fcn"};
this.def["rt_atan2d_snf"] = {file: "biomasa_c.html",line:402,type:"fcn"};
this.def["biomasa_step"] = {file: "biomasa_c.html",line:439,type:"fcn"};
this.def["biomasa_derivatives"] = {file: "biomasa_c.html",line:1319,type:"fcn"};
this.def["biomasa_initialize"] = {file: "biomasa_c.html",line:1440,type:"fcn"};
this.def["biomasa_terminate"] = {file: "biomasa_c.html",line:1693,type:"fcn"};
this.def["B_biomasa_T"] = {file: "biomasa_h.html",line:99,type:"type"};
this.def["DW_biomasa_T"] = {file: "biomasa_h.html",line:225,type:"type"};
this.def["X_biomasa_T"] = {file: "biomasa_h.html",line:249,type:"type"};
this.def["XDot_biomasa_T"] = {file: "biomasa_h.html",line:273,type:"type"};
this.def["XDis_biomasa_T"] = {file: "biomasa_h.html",line:297,type:"type"};
this.def["ConstB_biomasa_T"] = {file: "biomasa_h.html",line:303,type:"type"};
this.def["ODE8_IntgData"] = {file: "biomasa_h.html",line:313,type:"type"};
this.def["ExtU_biomasa_T"] = {file: "biomasa_h.html",line:322,type:"type"};
this.def["ExtY_biomasa_T"] = {file: "biomasa_h.html",line:331,type:"type"};
this.def["RT_MODEL_biomasa_T"] = {file: "biomasa_types_h.html",line:20,type:"type"};
this.def["biomasa_ConstB"] = {file: "biomasa_data_c.html",line:20,type:"var"};
...
function Html2SrcLink() {
	...
	this.html2SrcPath["biomasa_c.html"] = "../biomasa.c";
	this.html2Root["biomasa_c.html"] = "biomasa_c.html";
	this.html2SrcPath["biomasa_h.html"] = "../biomasa.h";
	this.html2Root["biomasa_h.html"] = "biomasa_h.html";
	this.html2SrcPath["biomasa_private_h.html"] = "../biomasa_private.h";
	this.html2Root["biomasa_private_h.html"] = "biomasa_private_h.html";
	this.html2SrcPath["biomasa_types_h.html"] = "../biomasa_types.h";
	this.html2Root["biomasa_types_h.html"] = "biomasa_types_h.html";
	this.html2SrcPath["biomasa_data_c.html"] = "../biomasa_data.c";
	this.html2Root["biomasa_data_c.html"] = "biomasa_data_c.html";
...
var fileList = [
"ert_main_c.html","biomasa_c.html","biomasa_h.html","biomasa_private_h.html","biomasa_types_h.html","biomasa_data_c.html","rtGetInf_c.html","rtGetInf_h.html","rtGetNaN_c.html","rtGetNaN_h.html","rt_defines_h.html","rt_nonfinite_c.html","rt_nonfinite_h.html","rtwtypes_h.html"];
