###########################################################################
## Makefile generated for Simulink model 'MPC'. 
## 
## Makefile     : MPC.mk
## Generated on : Fri Feb 02 10:32:54 2018
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/MPC.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = L:/PROYEC~2/PROYEC~1/Modelos/MPC_CA~1
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = MPC_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/MPC.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/MPC_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=MPC -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/MPC_ert_rtw/MPC.c $(START_DIR)/MPC_ert_rtw/rtGetInf.c $(START_DIR)/MPC_ert_rtw/rtGetNaN.c $(START_DIR)/MPC_ert_rtw/rt_nonfinite.c

MAIN_SRC = $(START_DIR)/MPC_ert_rtw/ert_main.c
...
OBJS = MPC.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj
