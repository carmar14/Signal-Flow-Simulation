/*
 * File: pv_csi_prueba.h
 *
 * Code generated for Simulink model 'pv_csi_prueba'.
 *
 * Model version                  : 1.12
 * Simulink Coder version         : 8.14 (R2018a) 06-Feb-2018
 * C/C++ source code generated on : Wed Mar  6 11:41:08 2019
 *
...
#ifndef RTW_HEADER_pv_csi_prueba_h_
#define RTW_HEADER_pv_csi_prueba_h_
#include <math.h>
#include <string.h>
#ifndef pv_csi_prueba_COMMON_INCLUDES_
# define pv_csi_prueba_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "rtw_continuous.h"
#include "rtw_solver.h"
#endif                                 /* pv_csi_prueba_COMMON_INCLUDES_ */

#include "pv_csi_prueba_types.h"
#include "rtGetInf.h"
...
typedef struct {
  ...
  real_T i3;                           /* '<Root>/i3' */
  real_T d;                            /* '<Root>/d' */
} ExtY_pv_csi_prueba_T;

/* Real-time Model Data Structure */
struct tag_RTM_pv_csi_prueba_T {
  const char_T *errorStatus;
  RTWSolverInfo solverInfo;
  X_pv_csi_prueba_T *contStates;
...
/* Block signals (default storage) */
extern B_pv_csi_prueba_T pv_csi_prueba_B;

/* Continuous states (default storage) */
extern X_pv_csi_prueba_T pv_csi_prueba_X;

/* Block states (default storage) */
extern DW_pv_csi_prueba_T pv_csi_prueba_DW;

/* External inputs (root inport signals with default storage) */
extern ExtU_pv_csi_prueba_T pv_csi_prueba_U;

/* External outputs (root outports fed by signals with default storage) */
extern ExtY_pv_csi_prueba_T pv_csi_prueba_Y;

/* Constant parameters (default storage) */
extern const ConstP_pv_csi_prueba_T pv_csi_prueba_ConstP;

/* Model entry point functions */
extern void pv_csi_prueba_initialize(void);
extern void pv_csi_prueba_step(void);
extern void pv_csi_prueba_terminate(void);

/* Real-time Model object */
extern RT_MODEL_pv_csi_prueba_T *const pv_csi_prueba_M;
 ...
 *
 * '<Root>' : 'pv_csi_prueba'
 * '<S1>'   : 'pv_csi_prueba/CSI_Control_BIO1'
 * '<S2>'   : 'pv_csi_prueba/MATLAB Function SOC '
 * '<S3>'   : 'pv_csi_prueba/MPC Controller1'
 * '<S4>'   : 'pv_csi_prueba/CSI_Control_BIO1/PQ2Iab_PH1'
 * '<S5>'   : 'pv_csi_prueba/CSI_Control_BIO1/PQ_singlePhase'
 * '<S6>'   : 'pv_csi_prueba/CSI_Control_BIO1/PR Controller_0_ref 1'
 * '<S7>'   : 'pv_csi_prueba/CSI_Control_BIO1/PR Controller_0_ref 1/Steper6'
 * '<S8>'   : 'pv_csi_prueba/MPC Controller1/MPC'
 * '<S9>'   : 'pv_csi_prueba/MPC Controller1/MPC/MPC Matrix Signal Check'
 * '<S10>'  : 'pv_csi_prueba/MPC Controller1/MPC/MPC Matrix Signal Check1'
 * '<S11>'  : 'pv_csi_prueba/MPC Controller1/MPC/MPC Matrix Signal Check2'
 * '<S12>'  : 'pv_csi_prueba/MPC Controller1/MPC/MPC Preview Signal Check'
 * '<S13>'  : 'pv_csi_prueba/MPC Controller1/MPC/MPC Preview Signal Check1'
 * '<S14>'  : 'pv_csi_prueba/MPC Controller1/MPC/MPC Scalar Signal Check'
 * '<S15>'  : 'pv_csi_prueba/MPC Controller1/MPC/MPC Scalar Signal Check1'
 * '<S16>'  : 'pv_csi_prueba/MPC Controller1/MPC/MPC Vector Signal Check'
 * '<S17>'  : 'pv_csi_prueba/MPC Controller1/MPC/MPC Vector Signal Check1'
 * '<S18>'  : 'pv_csi_prueba/MPC Controller1/MPC/MPC Vector Signal Check11'
 * '<S19>'  : 'pv_csi_prueba/MPC Controller1/MPC/MPC Vector Signal Check2'
 * '<S20>'  : 'pv_csi_prueba/MPC Controller1/MPC/MPC Vector Signal Check3'
 * '<S21>'  : 'pv_csi_prueba/MPC Controller1/MPC/MPC Vector Signal Check4'
 * '<S22>'  : 'pv_csi_prueba/MPC Controller1/MPC/MPC Vector Signal Check5'
 * '<S23>'  : 'pv_csi_prueba/MPC Controller1/MPC/MPC Vector Signal Check6'
 * '<S24>'  : 'pv_csi_prueba/MPC Controller1/MPC/MPC Vector Signal Check7'
 * '<S25>'  : 'pv_csi_prueba/MPC Controller1/MPC/MPC Vector Signal Check8'
 * '<S26>'  : 'pv_csi_prueba/MPC Controller1/MPC/MPC Vector Signal Check9'
 * '<S27>'  : 'pv_csi_prueba/MPC Controller1/MPC/optimizer'
 */
#endif                                 /* RTW_HEADER_pv_csi_prueba_h_ */
