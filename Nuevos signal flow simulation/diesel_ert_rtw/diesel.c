...
void diesel_step(void)
{
...

  {
     ...
     */
    rtb_Actuador1 = rt_atan2d_snf(diesel_B.Switch_l, diesel_B.Switch_a);
     ...
     *  RealImagToComplex: '<S7>/Real-Imag to Complex'
     */
    rtb_coswt = rt_hypotd_snf(diesel_B.Switch, diesel_B.Switch_m) *
    ...
    rtb_phi = (57.295779513082323 * rt_atan2d_snf(diesel_B.Switch_m,
                diesel_B.Switch) - 57.295779513082323 * rtb_Actuador1) *
    ...
    rtb_Actuador1 = diesel_X.Integrator8_CSTATE;

    /* Outport: '<Root>/i3' */
    diesel_Y.i3 = rtb_Actuador1;

    /* Gain: '<Root>/Gain11' incorporates:
     *  Integrator: '<Root>/Integrator6'
     *  Sum: '<Root>/Sum7'
     */
    diesel_B.Gain11 = (diesel_X.Integrator6_CSTATE - rtb_Actuador1) *
      1639.344262295082;
    ...
    if ((diesel_DW.TimeStampA >= diesel_M->Timing.t[0]) && (diesel_DW.TimeStampB
      ...
      rtb_coswt = (diesel_B.refvoltage - *lastU) / (diesel_M->Timing.t[0] -
        rtb_coswt);
    }
     ...
     *  Sum: '<Root>/Sum12'
     */
    diesel_B.Sum11 = (0.00061 * rtb_coswt + rtb_Actuador1) -
     ...
     */
    rtb_coswt = (2.0 * diesel_X.TransferFcn2_CSTATE[0] + 0.0 *
    ...
    diesel_Y.duty_cycle = rtb_coswt;

    /* Outport: '<Root>/bus_dc' */
    diesel_Y.bus_dc = diesel_B.OutputDCVoltage;

    /* Sum: '<Root>/Sum13' incorporates:
     *  Inport: '<Root>/ref'
     */
    rtb_coswt = diesel_U.ref - diesel_B.OutputDCVoltage;
     ...
     *  Sum: '<S4>/SumD'
     */
    diesel_B.FilterCoefficient = (0.00224356290205903 * rtb_coswt -
      diesel_X.Filter_CSTATE) * 0.155980576752107;

    /* Sum: '<S4>/Sum' incorporates:
     *  Gain: '<S4>/Proportional Gain'
     *  Integrator: '<S4>/Integrator'
     */
    diesel_B.Sum = (0.000853612192208084 * rtb_coswt +
                    diesel_X.Integrator_CSTATE) + diesel_B.FilterCoefficient;

    /* Gain: '<S4>/Integral Gain' */
    diesel_B.IntegralGain = 3.94394231511782E-5 * rtb_coswt;
     ...
     *  Sin: '<S6>/sin(wt)'
     */
    diesel_B.Product = rtb_phi * diesel_X.Integrator7_CSTATE;
     ...
     *  Sin: '<S6>/cos(wt)'
     */
    diesel_B.Product1 = rtb_Product1 * diesel_X.Integrator7_CSTATE;
    ...
    diesel_B.Gain12 = ((diesel_X.Integrator7_CSTATE - diesel_U.Vload) - 0.001 *
                       rtb_Actuador1) * 99999.999999999985;

    /* Product: '<S7>/Product' */
    diesel_B.Product_a = rtb_phi * rtb_Actuador1;

    /* Product: '<S7>/Product1' */
    diesel_B.Product1_e = rtb_Product1 * rtb_Actuador1;
